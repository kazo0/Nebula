...
public class CreditsScene extends MenuScene 
{
	...
	public CreditsScene()
	{
		...
		SpriteBackground bg = new SpriteBackground(new Sprite(0, 0, GraphicContainer.getSharedInstance().creditsBackground, BaseActivity.getSharedInstance().getVertexBufferObjectManager()));
        setBackground(bg);
